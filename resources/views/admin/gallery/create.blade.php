                ...
                <div class="col-lg-8">
                    <div class="form-group">
                        <form action="{{ route('gallery-post') }}" method="post" enctype="multipart/form-data">
                            ...
                            <Textarea name="description" cols="20" rows="4" class="form-control m-2 @error('description') is-invalid @enderror summernote" placeholder="Keterangan">{{ old('description') }}</Textarea>
                            @error('description')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <input type="file" id="input-file-now-custom-3" class="form-control m-2 @error('cover') is-invalid @enderror" name="cover">
                            @error('cover')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
