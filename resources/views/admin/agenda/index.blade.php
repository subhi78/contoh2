...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <a href="{{ route('agenda-create') }}" class="btn btn-outline-success mb-3 mt-3">Tambah Baru</a>
                ...
                <tbody>
                    ...
                    @foreach ($agenda as $post)
                        <tr>
                            ...
                            <td>{!! $post->lokasi !!}</td>
                            <td>{{ $post->tanggal }}</td>
                            <td><img src="poster/{{ $post->gambar }}" class="img-responsive"
                                    style="max-height:200px; max-width:200px" alt="" srcset=""></td>
                            <td>
                                <div class="btn-group">
                                        <form action="{{ route('agenda-delete', $post->id) }}" method="post">
