...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <a href="{{ route('dokumen-create') }}" class="btn btn-outline-success mb-3 mt-3">Tambah Baru</a>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <a href="#" class="btn btn-outline-danger">
                                        <form action="{{ route('dokumen-delete', $post->id) }}" method="post">
                                            <button class="btn btn-uotline-danger"
