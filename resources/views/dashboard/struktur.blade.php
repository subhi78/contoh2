...
<body>
  ...
  <section id="topbar" class="d-flex align-items-center">
   ...
   <header id="header" class="d-flex align-items-center">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <div class="logo">
        <a href="index.html"><img src="assets/img/logo.png" alt="" class="img-fluid" data-aos="flip-left"
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>UPT Humas UNW</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
          ...
          <li><a href="download.html"><button type="button" class="btn btn-outline-info"><span>Download</span></button></li></a>
        </ul>
  ...
  <main id="main">
    ...
    <div class="section-header" data-aos="zoom-in" data-aos-duration="1000">
      <h2>Struktur Humas UNW</h2>
      <p>Struktural Organisasi UPT Humas <span>UNW</span></p>
    </div>
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="member">
              <img src="/assets/img/Asset 1.png" alt="">
              <h4>Yoannes Romando Sipayung,S.Kom.,M.Kom</h4>
              <span>Kepala Bagian Humas</span>
              <div class="social">
                <a href=""><i class="bi bi-twitter"></i></a>
                <a href=""><i class="bi bi-facebook"></i></a>
                <a href=""><i class="bi bi-instagram"></i></a>
      ...
      <div class="container">
        <div class="section-header mt-5" data-aos="zoom-in" data-aos-duration="1000">
          <h2>Magang Humas UNW</h2>
          <p>Magang UPT Humas <span>UNW</span></p>
        </div>
            <div class="row">
              <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                <div class="member">
